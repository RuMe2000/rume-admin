...
import { getPendingProperties } from '../../utils/firestoreUtils';
    ...
    return (
        <div>
            <div className='flex flex-row items-center text=white gap-3 mb-6'>
                ...
                <h1 className='text-3xl font-semibold'>Pending Properties</h1>
            </div>
                    ...
                    <tbody>
                        {pendingProperties.map((property) => (
                            <tr key={property.id} className='text-center border-b border-darkGray'>
                                ...
                                <td className='px-2 py-2'>{property.name || 'Unknown'}</td>
                                <td className='px-2 py-2'>{property.address || 'Unknown'}</td>
