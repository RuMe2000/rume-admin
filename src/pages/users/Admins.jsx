...
import { getAllAdmins } from "../../utils/firestoreUtils";
    ...
    return (
        <div>
            <div className="flex flex-row items-center text=white gap-3 mb-6">
                <button onClick={() => navigate('/users')} className="cursor-pointer hover:bg-mainBlue p-1 rounded-lg duration-500 transition">
                        ...
                        {admins.map((admin, index) => (
                            <tr key={admin.id} className='text-center border-b border-darkGray'>
                                ...
                                <td className='px-4 py-2'>
                                    <button className='bg-errorRed px-3 py-1 rounded-lg hover:bg-red-700 duration-300 transition'>Delete</button>
                                </td>
