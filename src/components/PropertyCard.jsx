...
const PropertyCard = () => {
    ...
    const filteredProperties = useMemo(() => {
        ...
        // sort by createdAt or dateVerified
        result.sort((a, b) => {
    ...
    return (
        <div className="p-2">
            ...
            {isLoading ? (
                ...
                <div className="flex-1 overflow-y-auto max-h-[60vh] px-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-5">
                    {filteredProperties.map((property) => (
                        ...
                        >
                            <img
                                ...
                                alt={property.name}
                                className={`absolute inset-0 w-full h-full object-cover transition duration-300 ${property.status === "rejected"
