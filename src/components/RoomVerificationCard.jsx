...
export const RoomVerificationCard = ({ onManage }) => {
    ...
    return (
        <button
            onClick={onManage}
            className="w-[45vh] h-[25vh] text-left bg-orange rounded-2xl shadow-xl shadow-bgBlue px-5 mr-5 py-3 flex flex-col justify-between hover:bg-orange-600/50 hover:scale-105 transition duration-300 cursor-pointer">
